...
As of March 2023, the site is built with the static website framework [Hugo](https://gohugo.io/) and hosted on my Oracle Cloud Server. Currently it is rendered in the theme [PaperMod](https://github.com/adityatelange/hugo-PaperMod).

## License
*[CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/)* unless otherwise suggested. 